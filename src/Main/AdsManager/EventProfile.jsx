...
import styles from "./AdsProfile.module.css";
...
export default function EventProfile() {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        data.url + "/admin/ad/get-indi-event",
        { id: id },
  ...
  const verify = () => {
    axios
      .post(
        data.url + "/admin/ad/verify-event",
        {
          id: id,
        },
        {
      ...
      <main className={styles.main_main_main}>
        <div className={styles.important_info_section}>
          ...
          <div className={styles.profile_info}>
            ...
            {information.createdAt != undefined ? (
              <div className={styles.profile_create_date}>
                Created :{" "}
                {information.createdAt.split("T")[0].split("-")[2] +
                  "-" +
                  information.createdAt.split("T")[0].split("-")[1] +
                  "-" +
                  information.createdAt.split("T")[0].split("-")[0]}
              </div>
            ) : null}
          </div>
