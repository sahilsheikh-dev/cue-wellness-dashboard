...
export default function CoachDetails() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-blue-50 rounded-lg">
      {/* Top Progress Bar */}
      {isActive && (
      ...
      {/* Sidebar */}
      <div className="w-64 bg-white shadow-lg flex flex-col py-6 px-4">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col sm:flex-row items-start gap-6">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className=" text-gray-700">
                    ...
                    {coach.deletedAT ? (
                      <p>
                        <span className="font-semibold">⏱️ Deleted Date:</span>{" "}
                        {coach.deletedAT}
                      </p>
                    ) : null}
                  </div>
                    ...
                    return (
                      <li key={asset.id || asset.index}>
                        <a
                          ...
                          className="text-blue-600 hover:underline break-all"
                        >
                          {fileName || asset.type?.toUpperCase() || "Not Found"}
                        </a>
                      </li>
                    );
                  })}
